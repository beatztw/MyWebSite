        ...
        <div class="page__inner">
            ...
            <div class="w-25 mx-auto">
                <form class="box" action="" method="post">
                    ...
                    <button type="submit" class="btn btn-primary" id="swalTrigger">Войти</button>
                </form>
            </div>
        </div>
    </div>
...
<%--<script>--%>
<%--    const swalTrigger = document.getElementById('swalTrigger');--%>

<%--    swalTrigger.addEventListener('click', () => {--%>
<%--        Swal.fire({--%>
<%--            title: 'Title',--%>
<%--            icon: 'success',--%>
<%--            text: 'Lorem...',--%>
